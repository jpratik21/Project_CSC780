...
/**
 * HoleAction is responsible for drawing the holes in the way. The boolean value
 * of alive decides whether to draw the hole on the screen or not.
 * 
 * @author jpratik
 *
 */
...
class Hole {
	...
	public void draw(Canvas canvas) {
		canvas.drawRect(x, y, x + w, y + h, game.transPaint);
	}
