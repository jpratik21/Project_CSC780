...
/**
 * CoinAction is responsible for drawing the coins in sky. This makes use of the
 * RecF class to hold the coordinates of the coin image to be drawn. The boolean
 * value decides whether to draw the coin on the screen or not.
 * 
 * @author jpratik
 *
 */
...
public class CoinAction {
	...
	public CoinAction(GameActivity game) {
